...
Il progetto svolto nelle lezioni di laboratorio prevede l'utilizzo di una collezione di dati fornita dal docente; la collezione utilizzata (disponibile anche online) \'e una raccolta di articoli scientifici tratti dalla rivista \textit{Communications of the ACM} \cite{ACMCollection} %TODO far funzionare il cite (url: http://ir.dcs.gla.ac.uk/resources/test_collections/cacm/)
