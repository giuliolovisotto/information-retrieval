...
Il resto del documento \`e organizzato come segue. In Sezione \ref{sec:metodologia} vengono descritti i metodi sviluppati per ciascun laboratorio. In Sezione \ref{sec:risult-sper} vengono discussi i risultati ottenuti per i vari laboratori, e vengono descritte alcune considerazioni sull'efficienza dei metodi utilizzati. Infine la Sezione \ref{sec:conclusioni} conclude il documento con alcune conclusioni generali.
